...
const definitions = [
    ...
    },
    {
        ...
        meta: {
            tuyaDatapoints: [
                ...
                [24, 'local_temperature', tuya.valueConverter.divideBy10],
                [31, 'working_day', tuya.valueConverterBasic.lookup({ '5/2': tuya.enum(0), '6/1': tuya.enum(1), '7/0': tuya.enum(2) })],
    ...
    },
    {
        ...
        vendor: 'Tuya',
        description: 'Light sensor',
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.illuminance],
        toZigbee: [],
        configure: tuya.configureMagicPacket,
    ...
    },
    {
        ...
        extend: [tuyaBase({ dp: true }), (0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 1, l3: 1, l4: 1 } })],
        exposes: [
            tuya.exposes.switch().withEndpoint('l1'),
            tuya.exposes.switch().withEndpoint('l2'),
            tuya.exposes.switch().withEndpoint('l3'),
